...
namespace MY_MVC_APPLICATION.Controllers
{
	...
	[GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
	public partial class T4MVC_AccountController : MY_MVC_APPLICATION.Controllers.AccountController
	{
		...
		[NonAction]
		partial void LoginOverride(T4MVC_System_Web_Mvc_ViewResult callInfo, Models.User user);

		[NonAction]
		public override System.Web.Mvc.ViewResult Login(Models.User user)
		{
			var callInfo = new T4MVC_System_Web_Mvc_ViewResult(Area, Name, ActionNames.Login);
